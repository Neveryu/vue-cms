<template>
  <div class="content-wrapper">
    ...
    <el-table v-loading="tableDataLoading" :data="tableData" class="data-table">
      ...
      <el-table-column prop="attribute[3].attrValue" label="实时票房" width="120"></el-table-column>
      <el-table-column prop="attribute[4].attrValue" label="票房占比" width="120"></el-table-column>
      <el-table-column prop="attribute[5].attrValue" label="排片占比" width="120"></el-table-column>
