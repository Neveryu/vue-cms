  ...
  <div>
    <el-table :data="tableData" :max-height="maxHeight" show-summary :summary-method="getSummaries" style="width: 100%">
      ...
      <el-table-column align="center" label="发起任务">
        <el-table-column property="total" align="center" label="任务发起" show-overflow-tooltip></el-table-column>
        <el-table-column property="passcount" align="center" label="审核通过" show-overflow-tooltip></el-table-column>
      ...
      <el-table-column align="center" label="任务办理">
        <el-table-column property="notdo" align="center" label="未开始" show-overflow-tooltip></el-table-column>
        <el-table-column property="doing" align="center" label="办理中" show-overflow-tooltip></el-table-column>
        <el-table-column property="voertime" align="center" label="已过期" show-overflow-tooltip></el-table-column>
        <el-table-column property="getover" align="center" label="已完成" show-overflow-tooltip></el-table-column>
