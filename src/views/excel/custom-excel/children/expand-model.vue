      ...
      <template v-if="tableData.length > 0">
        <el-col class="file-item" v-for="fileItem of tableData" :key="fileItem.id">
          <el-card shadow="hover" class="file-item-card" :class="{ active: false }">
            ...
            <div
              v-if="fileItem.materialType === 2"
              class="file-img word"
              :class="{ pdf: fileItem.fileType === 'pdf', ppt: fileItem.fileType === 'ppt' || fileItem.fileType === 'pptx' }"></div>
            ...
            <span class="item">
              <span
                :title="fileItem.createdUserName"
                class="author"
                style="display: inline-block; width: 47%; overflow: hidden; text-overflow: ellipsis">
                {{ fileItem.createdUserName }}
              </span>
              <span
                :title="fileItem.createdOrgName"
                class="address"
                style="float: right; display: inline-block; width: 50%; overflow: hidden; text-overflow: ellipsis">
                {{ fileItem.createdOrgName }}
              </span>
            </span>
            ...
            <span class="item download" v-if="fileItem.materialType === 1 || fileItem.materialType === 2 || fileItem.materialType === 3">
              下载量： {{ fileItem.downloadCount || 0 }}
            </span>
