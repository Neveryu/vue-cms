<template>
  <div class="container">
    ...
    <!-- 数据列表-->
    <data-list v-if="showFlag === 2" :p-id="pId" :ques-id="quesId" :dept-id="deptId" @backFromList="_backFromList"></data-list>
  </div>
</template>
<script>
...
.container {
  ...
  .header {
    ...
    border-image: url('~@/assets/image/echarts/title.png') 13 60 stretch;
    .name {
