<template>
  <div class="profile-wrapper">
    ...
    <my-upload ref="myUpload" field='img' v-model="show" @crop-success="cropSuccess" @crop-upload-success="cropUploadSuccess" @crop-upload-fail="cropUploadFail"></my-upload>
  </div>
</template>
<script>
