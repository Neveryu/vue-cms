  ...
  data() {
    return {
      ...
      rules: {
        ...
        sysMark: [{ required: true, message: '请输入系统标识', trigger: 'blur' }],
        accountMark: [{ required: true, message: '请输入账号标识', trigger: 'blur' }],
        region1: [{ required: true, message: '请选择地区', trigger: 'blur' }],
        region2: [{ required: true, message: '请选择城市', trigger: 'blur' }],
        concat: [{ max: 20, message: '20 字以内，非必填', trigger: 'blur' }],
        depart: [{ max: 20, message: '20 字以内，非必填', trigger: 'blur' }],
        remarks: [{ max: 200, message: '200 字以内，非必填', trigger: 'blur' }],
      },
    }
  },
  // computed: {
